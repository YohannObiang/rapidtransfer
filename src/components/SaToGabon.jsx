...
export default function SaToGabon() {
  ...
  <div>
    <Card sx={{padding:'20px 10px', height:'fit-content'}}>
        <Typography component="h1" variant="h5">
          Convertisseur de devises (ZAF-XAF)
        </Typography>
        <form noValidate>
          ...
          <TextField
            ...
            fullWidth
            name="number"
            label="Montant à envoyer (Rand sud-africain)"
            type="number"
            id="toReceive"
          ...
          <TextField
            ...
            disabled
            name="number"
            label="Frais inclus (Rand sud-africain)"
            type="number"
            id="toReceive"
          ...
          <TextField
            ...
            fullWidth
            id="toReceive"
            label="Montant à recevoir (Franc CFA)"
            name="number"
            type="number"
